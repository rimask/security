...
![EU-Standardvertragsklausel für Datenschutz](images/icon_eumc.png) Vereinbarungen, die die **Standardvertragsklauseln der Europäischen Union (EU)** umfassen, schützen personenbezogene Daten, die aus der EU oder aus dem europäischen Wirtschaftsraum (EWR) in ein Drittland übertragen werden. Die EU-Standardvertragsklausel wird zwischen dem Kunden, der sich in der EU oder im EWR befindet, als Datenexporteur, und dem IBM Datenverarbeiter, der sich in dem Drittland befindet, als Datenimporteur unterzeichnet. Die Ergänzenden Bedingungen zur Auftragsverarbeitung (EB-AV) von IBM (mit EU-Standardvertragsklauseln) enthalten die Rechte und Verpflichtungen des Datenexporteurs und des Datenimporteurs sowie die Rechte der betroffenen Personen. Der mit den Ergänzenden Bedingungen zur Auftragsverarbeitung (EB-AV) von IBM verfügbare Schutz ist mit dem in der EU bzw. im europäischen Wirtschaftsraum verfügbaren Schutz für personenbezogene Daten, die in einem Drittland verarbeitet werden, vergleichbar.



![Finanzwirtschaftliche Informationssysteme](images/FISC.gif) Für Bankunternehmen und zugehörige Finanzinstitute in Japan müssen für Computersysteme Sicherheitsverfahren auf der Basis der FISC-Sicherheitsrichtlinien (Center for Financial Industry Information Systems) eingerichtet sein. FISC-Sicherheitsrichtlinien werden von der Japan Financial Services Agency (FSA), Bank of Japan (BOJ) und FISC implementiert.
