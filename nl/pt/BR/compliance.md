...
Para obter mais informações ou assistência para alcançar, certificar e manter a conformidade HIPAA de seu ambiente do Bluemix, entre em contato com a equipe de [vendas do {{site.data.keyword.Bluemix_notm}} ![Ícone de link externo](../icons/launch-glyph.svg "Ícone de link externo")](mailto:cloudplatform_compliance@us.ibm.com){:new_window}.
